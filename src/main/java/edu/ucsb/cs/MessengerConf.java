...
public class MessengerConf {
    ...
    public MessengerConf() {
        messengerConfigurations.put(0, new Messenger("192.168.0.104", 9090, "us-west"));
        messengerConfigurations.put(1, new Messenger("192.168.0.106", 9090, "us-east"));
...
//        messengerConfigurations.put(2, new Messenger("54.72.205.132", 9090, "europe"));
//        messengerConfigurations.put(3, new Messenger("54.94.153.129", 9090, "south"));
//        messengerConfigurations.put(4, new Messenger("54.169.74.145", 9090, "singapore"));
    }
