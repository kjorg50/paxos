...
//        messengerConfigurations.put(0, new Messenger("localhost", 9090, "test-1"));
//        messengerConfigurations.put(1, new Messenger("localhost", 9091, "test-2"));
//        messengerConfigurations.put(2, new Messenger("localhost", 9092, "test-3"));
