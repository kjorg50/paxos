...
public class ProposalID implements org.apache.thrift.TBase<ProposalID, ProposalID._Fields>, java.io.Serializable, Cloneable, Comparable<ProposalID> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProposalID");
    ...
    static {
        schemes.put(StandardScheme.class, new ProposalIDStandardSchemeFactory());
        schemes.put(TupleScheme.class, new ProposalIDTupleSchemeFactory());
    }
    ...
    static {
        ...
        org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProposalID.class, metaDataMap);
    }
     ...
     */
    public ProposalID(ProposalID other) {
    ...
    public ProposalID deepCopy() {
        return new ProposalID(this);
    }
    ...
    public ProposalID setBallotNumber(long ballotNumber) {
        this.ballotNumber = ballotNumber;
        setBallotNumberIsSet(true);
        return this;
    }
    ...
    public ProposalID setUid(String uid) {
        this.uid = uid;
        return this;
    }
    ...
    public boolean equals(Object that) {
        if (that == null)
            return false;
        if (that instanceof ProposalID)
            return this.equals((ProposalID)that);
        return false;
    }

    public boolean equals(ProposalID that) {
        if (that == null)
            return false;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ProposalID(");
        boolean first = true;
    ...
    private static class ProposalIDStandardSchemeFactory implements SchemeFactory {
        public ProposalIDStandardScheme getScheme() {
            return new ProposalIDStandardScheme();
        }
    }

    private static class ProposalIDStandardScheme extends StandardScheme<ProposalID> {

        public void read(org.apache.thrift.protocol.TProtocol iprot, ProposalID struct) throws org.apache.thrift.TException {
        ...
        public void write(org.apache.thrift.protocol.TProtocol oprot, ProposalID struct) throws org.apache.thrift.TException {
            struct.validate();
    ...
    private static class ProposalIDTupleSchemeFactory implements SchemeFactory {
        public ProposalIDTupleScheme getScheme() {
            return new ProposalIDTupleScheme();
        }
    }

    private static class ProposalIDTupleScheme extends TupleScheme<ProposalID> {

        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, ProposalID struct) throws org.apache.thrift.TException {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, ProposalID struct) throws org.apache.thrift.TException {
